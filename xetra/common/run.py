...
from xetra.transformers.xetra_transformer import XetraSourceConfig, XetraTargetConfig, XetraETL
...
def main():
    ...
    # config = 'C:/Users/ayana/PycharmProjects/xetra-projects-pycharm/xetra_master/configs/xetra_report1_config.yml'
